...
public class BitstringExtensionTest {
    ...
    public static class LaneAttributes extends Asn1SequenceOf<Boolean> {
        ...
        public boolean getOrFalse(int i) { return (i < size()) ? get(i) : false; }
        public boolean isVehicleRevocableLane()  {return getOrFalse(0);}
        public boolean isVehicleFlyOverLane()    {return getOrFalse(1);}
        public boolean hovLaneUseOnly()          {return getOrFalse(2);}
        public boolean restrictedToBusUse()      {return getOrFalse(3);}
        public boolean restrictedToTaxiUse()     {return getOrFalse(4);}
        public boolean restrictedFromPublicUse() {return getOrFalse(5);}
        public boolean hasIRbeaconCoverage()     {return getOrFalse(6);}
        public boolean permissionOnRequest()     {return getOrFalse(7);}
    }
